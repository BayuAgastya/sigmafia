            ...
            <div class="col-sm-6 col-md-4 col-md-offset-4">
                ...
                <div class="account-wall">
                    <div class="text-center">
                        <img class="logo-2" href="<?= base_url('home'); ?>"><img src="<?= base_url('assets/main/'); ?>img/S logo.png" alt="" style="height: 100px;">
                    </div>
                    <form class="form-signin" method="POST" action="<?= base_url() ?>index.php/login">
                        ...
                        <a class="btn btn-primary btn-block" href="<?= base_url('home') ?>">Kembali</a>
