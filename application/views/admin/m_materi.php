                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <button type="button" class="ion-plus btn btn-block btn-primary" data-toggle="modal" data-target="#modal-tambah-materi"> Tambah materi</button>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
                                ...
                                <table class="table table-head-fixed">
                                    ...
                                    <tbody>
                                        <?php foreach ($matik_sd as $i) : ?>
                                            <tr>
                                                <td style="width:05%"><?= $i->id_materi; ?></td>
                                                <td style="width:05%"><?= $i->tingkat; ?></td>
                                                <td style="width:25%"><?= $i->judul; ?></td>
                                                <td style="width:20%"><?= $i->materi; ?></td>
                                                <td style="width:25%"><?= $i->deskripsi; ?></td>
                                                <td style="width:20%">
                                                    <a href="<?= base_url('hapusMateriMatik/' . $i->id_materi) ?>" type="button" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ?')">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                    <a href="<?= base_url('editMateriMatik/' . $i->id_materi) ?>" class="btn btn-info">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="<?= base_url('uploads/materi/matik/' . $i->materi) ?>" class="btn btn-success">
                                            ...
                                            <tbody>
                                                <?php foreach ($fisika_smp as $i) : ?>
                                                    <tr>
                                                        ...
                                                        <td style="width:25%"><?= $i->deskripsi; ?></td>
                                                        <td style="width:20%">
                                                            <a href="<?= base_url('hapusMateriFisika/' . $i->id_materi) ?>" type="button" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ?')">
                                                                <i class="fas fa-trash"></i>
                                                            </a>
                                                            <a href="<?= base_url('editMateriFisika/' . $i->id_materi) ?>" class="btn btn-info btn-circle">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <a href="<?= base_url('uploads/materi/fisika/' . $i->materi) ?>" class="btn btn-success btn-circle">
                                                                <i class="fas fa-download"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                            ...
                                            <tbody>
                                                <?php foreach ($kimia_smp as $i) : ?>
                                                    <tr>
                                                        ...
                                                        <td style="width:25%"><?= $i->deskripsi; ?></td>
                                                        <td style="width:20%">
                                                            <a href="<?= base_url('hapusMateriKimia/' . $i->id_materi) ?>" type="button" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ?')">
                                                                <i class="fas fa-trash"></i>
                                                            </a>
                                                            <a href="<?= base_url('editMateriKimia/' . $i->id_materi) ?>" class="btn btn-info btn-circle">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <a href="<?= base_url('uploads/materi/kimia/' . $i->materi) ?>" class="btn btn-success btn-circle">
                                                                <i class="fas fa-download"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
