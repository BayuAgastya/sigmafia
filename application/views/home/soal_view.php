                ...
                <div class="col-lg-6">
                    <div class="banner_content text-center">
                        ...
                        <div class="page_link">
                            ...
                            <a href="<?= base_url('soal'); ?>">Soal-soal</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="course_details_left">
            <div class="content_wrapper">
                ...
                <div id="SD" class="tabcontent" style="padding: 30px;">
                    <h4 class="title">Matematika SD</h4>
                    <div class="content">
                                ...
                                <?php foreach ($matik_sd as $i) : ?>
                                    <tr>
                                        ...
                                        <td style="text-align: end">
                                            <a class="genric-btn primary-border text-uppercase" href="<?= base_url('uploads/soal/matik/' . $i->soal) ?>"><span class="ti-download"></span> Download</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                ...
                <div id="SMP" class="tabcontent" style="padding: 30px;">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-matematika-smp" role="tabpanel" aria-labelledby="pills-matematika-smp-tab">
                            ...
                            <h4 class="title">Matematika SMP</h4>
                            <div class="content">
                                <?php if ($this->admin_model->is_role() == "user" & $this->admin_model->is_akses() == "yes") { ?>
                                    <table class="course_list">
                                    ...
                                    <table class="course_list">
                                        <?php foreach ($fisika_smp as $i) : ?>
                                            <tr>
                                                ...
                                                <td><?= $i->deskripsi; ?></td>
                                                <td style="text-align: end">
                                                    <a class="genric-btn primary-border text-uppercase" href="<?= base_url('uploads/soal/fisika/' . $i->soal) ?>"><span class="ti-download"></span> Download</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </table>
                                    ...
                                    <table class="course_list">
                                        <?php foreach ($kimia_smp as $i) : ?>
                                            <tr>
                                                ...
                                                <td><?= $i->deskripsi; ?></td>
                                                <td style="text-align: end">
                                                    <a class="genric-btn primary-border text-uppercase" href="<?= base_url('uploads/soal/kimia/' . $i->soal) ?>"><span class="ti-download"></span> Download</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </table>
                ...
                <!-- ========================================== pembatas ========================================== -->
                <div id="SMA" class="tabcontent" style="padding: 30px;">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-matematika-sma" role="tabpanel" aria-labelledby="pills-matematika-sma-tab">
                            <h4 class="title">Matematika SMA</h4>
                            <div class="content">
                                <?php if ($this->admin_model->is_role() == "user" & $this->admin_model->is_akses() == "yes") { ?>
                                    <table class="course_list">
