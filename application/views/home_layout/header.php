    ...
    <div class="main_menu">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <a class="navbar-brand logo_h" href="<?= base_url('home'); ?>"><img src="<?= base_url('assets/main/'); ?>img/Logo 2 Sigmafia 2020 with text.png" alt="" style="height: 40px;"></a>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <?php if ($this->admin_model->is_role() == "user") { ?>
                            <li class="nav-item submenu dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $this->session->userdata("user_name") ?></a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url('home/logout') ?>" type="submit" class="nav-link">Logout</a>
                            </li>
                        <?php } else { ?>
                            <li class="nav-item">
